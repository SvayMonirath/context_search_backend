const swaggerSpec = {
    ...
    info: {
        ...
        version: "1.0.0",
        description: "API documentation for authentication, profiles, integrations, and email fetching.",
    },
    servers: [
        {
        ...
        schemas: {
            ...
            GmailEmail: {
                ...
                properties: {
                    ...
                    snippet: { type: "string", example: "Hello, this is a sample message..." },
                    labelIds: {
                        type: "array",
                        items: { type: "string" },
                    ...
                    from: { type: ["string", "null"], example: "Jane Doe <jane@example.com>" },
                    subject: { type: ["string", "null"], example: "Project update" },
                    date: { type: ["string", "null"], example: "Thu, 22 May 2026 10:00:00 +0000" },
                },
            },
            SuccessResponse: {
                type: "object",
                        ...
                        content: {
                            "application/json": {
                                schema: {
                                    ...
                                    properties: {
                                        status: { type: "string", example: "success" },
                                        message: { type: "string", example: "Emails fetched successfully" },
                                        data: {
                                            type: "object",
                                            properties: {
                                                emails: {
