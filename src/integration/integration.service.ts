...
class IntegrationService {
  constructor(private googleOAuthservice: GoogleOAuthService, private integrationRepository: IntegrationRepository) {
  ...
  store_integration_data = async (data: z.infer<typeof Store_Integration_Request>) => {
