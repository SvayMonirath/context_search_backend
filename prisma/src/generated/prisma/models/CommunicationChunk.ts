...
// @ts-nocheck 
/*
 * This file exports the `CommunicationChunk` model and its related types.
 *
...
export type GetCommunicationChunkAggregateType<T extends CommunicationChunkAggregateArgs> = {
      [P in keyof T & keyof AggregateCommunicationChunk]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCommunicationChunk[P]>
    : Prisma.GetScalarType<T[P], AggregateCommunicationChunk[P]>
}
...
export type GetCommunicationChunkGroupByPayload<T extends CommunicationChunkGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CommunicationChunkGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CommunicationChunkGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CommunicationChunkGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CommunicationChunkGroupByOutputType[P]>
      }
    >
  >
...
export type CommunicationChunkCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CommunicationChunkFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CommunicationChunkDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CommunicationChunk'], meta: { name: 'CommunicationChunk' } }
  /**
   ...
   * })
  **/
  count<T extends CommunicationChunkCountArgs>(
    args?: Prisma.Subset<T, CommunicationChunkCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CommunicationChunkCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CommunicationChunkGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CommunicationChunkGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCommunicationChunkGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
